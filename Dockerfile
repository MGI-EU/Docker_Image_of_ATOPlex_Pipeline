...
RUN wget https://raw.githubusercontent.com/MGI-EU/Docker_Image_of_ATOPlex_Pipeline/main/assets/ATOPlex_Pipeline.Scripts.consensusSeqFiltering.py && mv ATOPlex_Pipeline_Report.Scripts.consensusSeqFiltering.py /root/repos/SARS-CoV-2_Multi-PCR_v1.0/tools/
